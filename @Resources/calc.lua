...
function dataParse ()
    ...
    eDate = rDate:copy():addmonths(1)
    p1Date = rDate:copy():addmonths(-1)
    p2Date = rDate:copy():addmonths(-2)
    p1Name = p1Date:copy():addmonths(1):getmonth()
    p2Name = p2Date:copy():addmonths(1):getmonth()
    cMName = rDate:copy():addmonths(1):getmonth()
